...
(
    ...
    has_intravelpolicy_variant_2_segment bool,
...
(request_id, has_intravelpolicy_variant, has_intravelpolicy_variant_1_segment,
 has_intravelpolicy_variant_2_segment,
 min_price, has_not_economy_in_policy,
...
select requestid                                                            as request_id,
       ...
       bool_or(intravelpolicy and segmentcount = 2)                         as has_intravelpolicy_variant_2_segment,
...
(
    ...
    days_request_before_flight  int
);
...
select id,
      ...
      (extract (epoch from (requestdeparturedate - requestdate) )) / 60 / 60 / 24 as days_request_before_flight
from agent_requests
