drop table if exists postprocess_model_015;
create table postprocess_model_015
(
...
create index on postprocess_model_015 (id);

insert into postprocess_model_015 (id, request_id, predict, score, rank,  sentoption_rank, sentoption_fixed_rank,
...
SELECT agent_requests.id,
       ...
       sentoption_fixed
from agent_requests
         join model_015 as predict on predict.id = agent_requests.id;
...
from postprocess_model_015
         join agent_requests_sample_001 sample on postprocess_model_015.id = sample.id;
...
with _tmp as (select 'accuracy' as class,
                     ...
                     null       as f1_score,
                     count(*)   as support
              from postprocess_model_015 as postprocess
