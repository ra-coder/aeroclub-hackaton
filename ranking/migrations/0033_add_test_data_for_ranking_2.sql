...
with _chippest_with_same_params as (select count(*)      as cnt,
                                    ...
                                    order by cnt desc)
update final_test_requests_features
set same_options_best_price = True
from _chippest_with_same_params
where id = any (_chippest_with_same_params.variant_ids)
